"""
nodes.py — Core LLM-powered functions for StatAgent.
...
async def generate_stat_response(
    ...
    """
    📊 Generate a StatAgent response based on context, Nexus intro, and Reco’s last statement.
    ...
    stat_prompt = (
        ...
        f"Respond to Reco’s point, focusing on data integrity, validation, and risk assessment aspects."
    )

    # Generate raw LLM response
    response = await llm(SYSTEM_STAT, stat_prompt)

    # ✨ Post-process for naturalness, dynamics, and clarity
...
if __name__ == "__main__":
    async def _test_stat_node():
        ...
        sample_intro = "Today’s focus is on ASA trends and processing time anomalies."
